    ...
    public SearchClient(BufferedReader serverMessages) throws Exception {
        ...
        while (!finished) {
            ...
            for (Agent agent : agentListByPriority) {
                if ((agent.getCurrentGoal() != null) || agent.moveToCornerCaseGoal || agent.destinationGoal != null ) { //An agent with an order to wait during clearing don't search for its goal for 1 turn
