...
public abstract class Heuristic implements Comparator<State> {
	...
	public double calculate_distance(State n, String method) {
        ...
        */
        ...
        double agentDistanceMinimum = getMinimumDistanceFromAgentToAssignedBox((Agent) State.realBoardObjectsById.get(n.getAgentId()), n.getLocalCoordinateById.get(n.getAgentId()), coordinateByBox, method);
        sum += agentDistanceMinimum;
        }
