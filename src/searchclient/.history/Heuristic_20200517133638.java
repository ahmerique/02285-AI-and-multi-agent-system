...
public abstract class Heuristic implements Comparator<State> {
	...
	public double calculate_distance(State n, String method) {
        ...
        HashMap<Agent, Coordinate> coordinateByAgent = this.getAllCoordinate(n, "Agent");
        
        // Get the minimum distance from each agent to the nearest box, and add the minimum distance to the Sum
        for (HashMap<Box, Coordinate> agent : coordinateByAgent.entrySet()) {
       ...
       */
		...
		// Get the minimum distance from each boxe to the nearest goal and add the minimum distance to the Sum
	 ...
	 */
	private double getMinimumDistanceFromAgentToBoxes(BoardObject agent, Coordinate agent_coordinates, HashMap<Box, Coordinate> coordinateByBox, String method) {
		double minimumDistance = 9999999; // Initialize the minimum distance at a very high value
